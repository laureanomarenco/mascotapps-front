    ...
    <div className='flex flex-col items-center w-full h-full '>
        ...
        <div className='grid md:grid-cols-3 gap-2 items-center justify-center content-center w-full px-4  max-h-fit ' >
            <div className='md:col-span-3 h-36 text-center flex content-center items-center justify-center'>
                <p className='text-4xl font-semibold uppercase text-[#28B0A2]'>Mi perfil de usuario</p>
            </div>
            ...
            <div className='flex flex-col w-full items-start justify-center gap-3 my-6 px-4  md:flex-row md:justify-center md:col-span-3'>
                <Link to="/" className='px-6 py-3  bg-[#FFC700] rounded-md font-bold hover:bg-[#ffd803]/80 transition-all duration-300' >Perdí mi mascota</Link>
                <Link to="/" className='px-6 py-3  bg-[#FFC700] rounded-md font-bold hover:bg-[#ffd803]/80 transition-all duration-300'>Encontré una mascota</Link>
                <Link to="/" className='px-6 py-3  bg-[#FFC700] rounded-md font-bold hover:bg-[#ffd803]/80 transition-all duration-300'>Dar en adopción</Link>
            </div>
        </div>
        <Footer/>
    </div>
