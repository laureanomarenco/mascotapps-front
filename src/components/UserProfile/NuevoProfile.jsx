                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                              ...
                              <div className="relative p-6 flex-auto">
                                <p className="my-4 text-slate-500 text-lg leading-relaxed">
                                  Tienes esta insignia porque has dado mascotas
                                  en adopción satisfactoriamente, para nosotros
                                  es una alegría siempre que esto sucede porque
                                  es uno de los motores que nos llevó a
                                  desarrollar esta página. Tanto las mascotas y
                                  personas que has ayudado, como todo el equipo
                                  de Mascotapp, te agradecen profundamente.
                                </p>
                              </div>
                              {/*footer*/}
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                              ...
                              <div className="relative p-6 flex-auto">
                                <p className="my-4 text-slate-500 text-lg leading-relaxed">
                                  ...
                                  principal por el que decidimos desarrollar
                                  esta página ya que tener perdido a un amigo
                                  peludo es una de las cosas más feas que nos
                                  puede pasar. Por eso te agradecemos con esta
                                  insignia en nombre del dueño, de la mascota y
