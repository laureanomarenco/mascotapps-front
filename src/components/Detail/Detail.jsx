        ...
        <div  className='my-4 flex flex-col'>
            ...
            (<div className='my-7 grid sm:grid-cols-2 sm:gap-6 sm:justify-center mx-auto sm:content-center font-sans'>
                ...
                <div className='text-justify flex flex-col  w-full h-full gap-5 px-10 py-3 '> 
                    <h1 className='text-5xl  text-teal-600 uppercase flex gap-3 items-center'><FaPaw/>{pet.name}</h1>
                    <div>
                        <p className='text-xl flex font-bold items-center gap-2 text-teal-800 '> Estado</p>
                    ...
                    <div>
                        ...
                        <p className='capitalize  text-teal-900'>{pet.vaccinationSchemeStatus}</p>
                    </div>
                    <p className='capitalize text-xl font-bold text-teal-600' >Contacto</p>
                </div>
                </div>) : (<h1>No Id</h1>)}
        </div>
        <Footer />
