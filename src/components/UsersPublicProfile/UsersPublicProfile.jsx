        ...
        <div className=" my-8 mx-3 md:mx-20 rounded-sm drop-shadow-md">
          ...
          <div className="grid md:grid-cols-2 gap-2 items-center justify-center content-center w-full px-4  max-h-fit ">
            ...
            <div className="w-52 h-52 rounded-full overflow-hidden mx-auto">
              <div className="flex absolute transition-all ease-in-out  duration-250	 cursor-pointer text-teal-500 hover:text-amber-400 top-5 right-0 text-4xl">
              {userProf?.gaveUpForAdoption > 0 && (
              <div>
                <button
                  type="button"
                  onClick={() => setActiveAdopterModal(true)}
                  className="absolute transition-all ease-in-out  duration-250	 cursor-pointer text-teal-500 hover:text-amber-400 top-5 right-0 text-4xl"
                  >
                  <MdPets />
                </button>
              </div>
                    ...
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                      ...
                      <div className="relative p-6 flex-auto">
                        <p className="my-4 text-slate-500 text-lg leading-relaxed">
                          Este usaurio tiene esta insignia porque ha dado mascotas en
                          adopción satisfactoriamente, para nosotros es una
                          alegría siempre que esto sucede porque es uno de los
                          motores que nos llevó a desarrollar esta página. Tanto
                          las mascotas y personas que este usuario ha ayudado, como todo el
                ...
                <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                  <div className="relative w-auto my-6 mx-auto max-w-3xl">
                    ...
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                      ...
                      <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                        <h3 className="text-3xl font-semibold">
                          ¡Este usuario ha ayudado a recuperar una mascota perdida!
                        </h3>
                        <button
                          className="p-1 ml-auto bg-transparent border-0 text-black opacity-5 float-right text-3xl leading-none font-semibold outline-none focus:outline-none"
                      ...
                      <div className="relative p-6 flex-auto">
                        <p className="my-4 text-slate-500 text-lg leading-relaxed">
                          Este usuario tiene esta insignia porque ha encontrado y devuelto
                          a su dueño una mascota extraviada, ¡esto es
                          importantísimo! y es el motivo principal por el que
                          decidimos desarrollar esta página ya que tener perdido
                          a un amigo peludo es una de las cosas más feas que nos
                          puede pasar. Por eso agradecemos con esta insignia
                          en nombre del dueño, de la mascota y de todo el equipo
                          de Mascotapp.
                        </p>
                      </div>
                      {/*footer*/}
                ...
                <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                  <div className="relative w-auto my-6 mx-auto max-w-3xl">
                    ...
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                      ...
                      <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                        <h3 className="text-3xl font-semibold">
                          ¡Este usuario ha ayudado económicamente a Mascotapp!
                        </h3>
                        <button
                          className="p-1 ml-auto bg-transparent border-0 text-black opacity-5 float-right text-3xl leading-none font-semibold outline-none focus:outline-none"
                      ...
                      <div className="relative p-6 flex-auto">
                        <p className="my-4 text-slate-500 text-lg leading-relaxed">
                          Este usuario tiene esta insignia porque ha decidido ayudarnos
                          haciendo una donación. Además de la satisfacción que
                          nos produce ayudar a conectar mascotas con sus dueños
                          Mascotapp necesita sostener su economía, y al ser un
                          página de acceso completamente gratuito ayudas como
                          estas son importantisimas para nosotros. ¡Por eso agradecemos enormemente a 
                          miembros de la comunidad como este usuario!
                        </p>
                      </div>
                      {/*footer*/}
                      <div className="flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b">
