...
const NuevoAdmin = () => {
  ...
  if (myProfileData && myProfileData?.userProps?.isAdmin === false)
    return <Error />;
  else if (myProfileData && myProfileData?.userProps?.isAdmin === true)
    return (
              ...
              <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6 w-[95vw] md:w-[90vw]">
                ...
                <div className="flex items-center p-8 bg-white w-[95vw] md:w-auto shadow rounded-lg">
                  <div className="inline-flex flex-shrink-0 items-center justify-center h-16 w-16 text-red-600 bg-red-100 rounded-full mr-6">
                    <FaDonate
                      className="mx-auto h-1/2 fill-red-600"
                      size={100}
                    />
                  </div>
                  <div>
  ...
  else if (!myProfileData.name) return <Spinner />;
};
