  ...
  return (
    <div className="w-screen overflow-x-hidden">
        <div className="flex bg-gray-100 min-h-screen">
          ...
          <aside className={`translate-x-[${modalActive ? "0%" : "-100%"}] transition-transform fixed top-0 left-0 h-full z-50 flex flex-col`}>
            <div className="inline-flex items-center justify-center h-20 w-20 bg-yellow-400 hover:bg-teal-500 focus:bg-purple-500">
              <img
                ...
                onClick={()=>{setModalActive(!modalActive);console.log(modalActive)}}
              />
            </div>
            ...
            <header className="w-full flex items-center h-20 bg-white w-screen justify-between px-2">
              <button className="relative flex-shrink-0 p-2 mr-2 text-gray-600 hover:bg-gray-100 hover:text-gray-800 focus:bg-gray-100 focus:text-gray-800 rounded-full"
            ...
            <main className="w-screen box-border p-2 md:p-10 space-y-6">
                ...
                <div className="row-span-3 bg-white shadow rounded-lg">
                  ...
                  <div className="overflow-y-auto">
                    <ul className="p-6 space-y-6">
                      {adoptionsRank?.map((u) => {
                        return (
                          <li className="flex items-center w-[80vw] md:w-full" key={u.id}>
